...
plot   "rocCurves/PingAnAI-DiscROC.txt" using 2:1 title 'PingAnAI' with linespoints pointinterval 80 lw 2 , \
"rocCurves/NanYunTech-DiscROC.txt" using 2:1 title 'NanYunTech' with linespoints pointinterval 80 lw 2 , \
"rocCurves/Glasssix-DiscROC.txt" using 2:1 title 'Glasssix' with linespoints pointinterval 80 lw 2 , \
"rocCurves/ReadSense_DiscROC_v2.txt" using 2:1 title 'ReadSense-v2' with linespoints pointinterval 80 lw 2 , \
"rocCurves/ReadSense_DiscROC_v1.txt" using 2:1 title 'ReadSense-v1' with linespoints pointinterval 80 lw 2 , \
"rocCurves/Authenmetric-CBSR-v1_DiscROC.txt" using 2:1 title 'Authenmetric-v2' with linespoints pointinterval 80 lw 2 , \
"rocCurves/wisesoft_DiscROC_v1.txt" using 2:1 title 'Wisesoft' with linespoints pointinterval 80 lw 2 , \
"rocCurves/TencentAI_FDDB_DiscROC.txt" using 2:1 title 'TencentAI.v1' with linespoints pointinterval 80 lw 2 , \
"rocCurves/MT-Face-v3-DiscROC.txt" using 2:1 title 'MT-Face-v3' with linespoints pointinterval 80 lw 2 , \
"rocCurves/HisignDiscROC_v2.txt" using 2:1 title 'Hisign-v2' with linespoints pointinterval 80 lw 2 , \
"rocCurves/THU-DiscROC.txt" using 2:1 title 'THU CV-AI Lab' with linespoints pointinterval 80 lw 2 , \
"rocCurves/Uniview-v1-DiscROC.txt" using 2:1 title 'Uniview' with linespoints pointinterval 80 lw 2 , \
"rocCurves/BAIDU-IDL-disc-v4.txt" using 2:1 title 'Baidu-IDL-v4' with linespoints pointinterval 80 lw 2 , \
"rocCurves/M-Face-tempDiscROC.txt" using 2:1 title 'MT-Face-V2' with linespoints pointinterval 80 lw 2 , \
"rocCurves/Emotibot-DiscROC.txt" using 2:1 title 'Emotibot' with linespoints pointinterval 80 lw 2, \
"rocCurves/Daream_Disc-v1.txt" using 2:1 title 'Daream' with lines lw 2 , \
"rocCurves/M-FaceDiscROC.txt" using 2:1 title 'MT-Face' with lines lw 2 , \
"rocCurves/Authenmetric_DiscROC.txt" using 2:1 title 'Authenmetric-v1' with lines lw 2 , \
